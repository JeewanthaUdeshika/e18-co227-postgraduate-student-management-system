        ...
        <CardContent>
          ...
          >
            <p style={{ fontSize: "20px", fontWeight: "bold" }}>
              The application forms may be obtained from the respctve Heads of
              Departments, Programme Cooordinators, or Assitan Registrar,
            ...
            >
              <ul>
                <li>
                  Application:{" "}
                  <span>
                    <a href="http://eng.pdn.ac.lk/cerps/forms/RPGapplication.doc">
                      MS Word
                    </a>
                    /
                    <a href="http://eng.pdn.ac.lk/cerps/forms/RPGapplication.pdf">
                      PDF
                    </a>
                  </span>
                </li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>Apppointment of Reviewers</li>

                    <li>
                      Form for Evaluating Research
                      Proposals-PGDip(research)/MPhill/PhD &nbsp;
                      <span>
                ...
                <li>
                  Get the duly completed application signed by the supervisor/s,
                  and submit it to the Head of the Department of Study where you
                  are planning to pursue your research.
                </li>
              </ul>
            </div>
          </div>
