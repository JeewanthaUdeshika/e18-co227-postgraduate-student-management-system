                ...
                <CardContent>
                    ...
                    <div style={{
                        ...
                        <p style={{fontSize: '20px', fontWeight: 'bold'}}>
                            Half-yearly and yearly reviews of research leading to M.Phil./Ph.D. degrees are held to monitor
                            progress and to keep track of the student's estimated date of completion. It is based upon a
                            self-evaluation form whereby the student reviews the stated objectives, success in attaining
                            objectives, publications, conference attendance, etc.. In addition, it allows the student and his/her
                            supervisor the opportunity to identify achievable targets for the coming 12 months.
                        </p>
                        ...
                        <div style={{
                            ...
                            <ul>
                                ...
                                <li>
                                    Half-yearly Progress Reports should be submitted through Supervisor/s to the respective
                                    Head of the Department (HOD).
                                </li>


                                <li>
                                    Yearly Progress Reports should be submitted to the Faculty Higher Degrees Committee
                                    (FHDC) through Supervisor/s, respective Head of the Department (HOD), and
                                    Director/CERPS
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            The composition of the Review Panel as follows
                                        </li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                One member from outside the department (nominated by the HOD and
                                                approved by the FHDC
                                            </li>

                                            <li>
                                                Supervisor(s) (as observer(s))
                                            </li>
                                        </ul>

                                        <li>
                                            The panel will submit their recommendations to the FHDC together with the
                                            Progress Report
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    Staff: Template for Nomination of Review Panels for M.Phil./Ph.D. Yearly Progress
                                    Reports
                                    <ul>
                                        <li>
                                            <span>
                                ...
                                <li>
                                    Staff: Template for Submission of Review Panel Recommendation of M.Phil./Ph.D. Yearly
                                    Progress Reports
                                    <ul>
                                        <li>
                                            <span>
                            ...
                            <table className='table table-striped'>
                                ...
                                <thead className='thead-dark'>
                                    <tr className='bg-info'>
                                        ...
                                        <th scope='col' colSpan={2}>Minimum Duration (Months)</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="3" style={{fontWeight: 'bold'}}>PG Research Programme &nbsp;
                                                    (Fully Research Based Programmes)
                                        </td>
                                        <td>PG Dip</td>
                                        <td>8</td>
                                        <td>12</td>
