 ...
 */
 ...
 export const registeredUser = RegisteredDB.discriminator('RegRegistered', registeredSchema, options);
 // Model for prospective students
 export const prospectiveUser = RegisteredDB.discriminator('RegProspective', prospectiveSchema, options);
  */
